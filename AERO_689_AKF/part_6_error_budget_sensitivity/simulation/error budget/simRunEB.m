...
function [state_hist, measurement_hist, estimate_hist] = simRunEB(inp, K_hist)
...
estimate = initialEstimateEB(inp, measurement, K_hist);  % xhat(t0)
...
for i = 1:inp.i_max
    ...
    estimate = simEKFEB(inp, measurement, estimate, i, K_hist);
